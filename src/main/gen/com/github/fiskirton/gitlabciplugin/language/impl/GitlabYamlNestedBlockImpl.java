...
public class GitlabYamlNestedBlockImpl extends GitlabYamlBlockImpl implements GitlabYamlNestedBlock {

  public GitlabYamlNestedBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public GitlabYamlBlock getBlock() {
    return findNotNullChildByClass(GitlabYamlBlock.class);
  }
